...
export default function StartFilePanel({ open = false }: { open: boolean }) {
  ...
  return (
    ...
    <div
      className={cn(
        "bg-panel-bg text-panel-text pointer-events-none fixed top-1/2 left-1/2 z-10 flex h-4/5 w-3/4 -translate-x-1/2 -translate-y-1/2 scale-75 transform flex-col items-center overflow-y-scroll rounded-md px-2 py-6 opacity-0",
        {
